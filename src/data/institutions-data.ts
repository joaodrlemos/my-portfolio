...
export const institutionsData: Record<Institution, InstitutionItem> = {
  [Institution.NAU]: {
    ...
    icon: getIcon(
      `${Institution.NAU}_ico-${ICON_COLOR}.svg`,
      'institutions',
      Institution.NAU,
    ),
  },
  [Institution.ATLASSIAN]: {
    ...
    icon: getIcon(
      `${Institution.ATLASSIAN}_ico-${ICON_COLOR}.svg`,
      'institutions',
      Institution.ATLASSIAN,
    ),
  },
  [Institution.FREECODECAMP]: {
    ...
    icon: getIcon(
      `${Institution.FREECODECAMP}_ico-${ICON_COLOR}.svg`,
      'institutions',
      Institution.FREECODECAMP,
    ),
  },
  [Institution.HACKERRANK]: {
    ...
    icon: getIcon(
      `${Institution.HACKERRANK}_ico-${ICON_COLOR}.svg`,
      'institutions',
      Institution.HACKERRANK,
    ),
  },
  [Institution.LINKEDIN]: {
    ...
    icon: getIcon(
      `${Institution.LINKEDIN}_ico-${ICON_COLOR}.svg`,
      'institutions',
      Institution.LINKEDIN,
    ),
  },
  [Institution.UDEMY]: {
    ...
    icon: getIcon(
      `${Institution.UDEMY}_ico-${ICON_COLOR}.svg`,
      'institutions',
      Institution.UDEMY,
    ),
  },
  [Institution.FCT]: {
    ...
    icon: getIcon(
      `${Institution.FCT}_ico-${ICON_COLOR}.svg`,
      'institutions',
      Institution.FCT,
    ),
  },
